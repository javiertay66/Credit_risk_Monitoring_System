...
In the real world, banks struggle with fragmented data—internal loan records sit in SQL databases, while client financial statements arrive in messy, unstandardized CSV/Excel files. This project builds a **fully automated credit risk monitoring pipeline** that:
...
Objective: Visualize the data for the Chief Operating Officer (COO).
...
(Note: View the full interactive dashboard by opening the .pbix file in the dashboard folder)
